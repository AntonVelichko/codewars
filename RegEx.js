...
// https://jsbin.com/wafimuzaye/edit?js,console
...
let crying = /(hoo+)+/i;
let hoo = 'Hooohoooohooooo';
console.log(crying.test('Hoohooohooo'));  //true
console.log(crying.test('Hoo'));  //true
console.log(hoo.replace(/ho+/i, ''));  //true
console.log(hoo.replace(/ho+/ig, ''));  //true
...
let email = /\w+@[0-9a-zA-Z-]+\.[a-zA-Z]{2,10}/
str = "olga@gmail.com"
